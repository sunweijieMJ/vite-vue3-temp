<template>
    <div v-if="secondMenu.children && secondMenu.children.length" class="layout-nav" :class="menuCollapse ? 'hide' : 'show'">
        ...
        >
            <sidebar-item v-for="item in secondMenu.children" :key="item.routePath" :item="item" :base-path="item.routePath" :is-collapse="false" />
        </el-menu>
    </div>
</template>
<script lang="ts">
