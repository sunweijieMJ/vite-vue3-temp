    ...
    >
        <div class="list-container">
            ...
            <custom-query v-model="state.form" @resetForm="resetForm" @queryForm="getList">
                ...
                <el-form-item>
                    <el-date-picker v-model="state.form.timeRange" value-format="YYYY-MM-DD HH:mm:ss" type="datetimerange" :start-placeholder="$t('baseTaskList.t149')" :end-placeholder="$t('baseTaskList.t150')" clearable />
                </el-form-item>
            </custom-query>
            <!-- 表格区域 -->
            <el-table class="custom-table" height="300" :data="state.tableInfo.list" @selection-change="selectTable">
