...
export default [
    {
        ...
        title: vueI18n.t('configMenu.t14'),
        routeName: 'common',
        routePath: '/common',
        children: [
            {
                iconCode: 'iconsecond_menu_masterdata',
                title: vueI18n.t('configMenu.t15'),
                routeName: 'basicmanage',
                routePath: '/common/basicmanage',
                children: [
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t16'),
                    ...
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t17'),
                        routeName: 'storelist',
                    ...
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t18'),
                    ...
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t19'),
                    ...
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t20'),
                    ...
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t21'),
                    ...
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t22'),
                    ...
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t23'),
    ...
    },
    {
        ...
        title: vueI18n.t('configMenu.t24'),
        routeName: 'rights',
        routePath: '/rights',
        children: [
            {
                iconCode: 'iconsecond_menu_user',
                title: vueI18n.t('configMenu.t25'),
                routeName: 'usermanage',
                routePath: '/rights/usermanage',
                children: [
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t26'),
                        routeName: 'userlist',
                    ...
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t27'),
                        routeName: 'rolelist',
                    ...
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t28'),
                    ...
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t29'),
                    ...
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t30'),
                        routeName: 'menulist',
            ...
            },
            {
                ...
                title: vueI18n.t('configMenu.t31'),
                routeName: 'logmanage',
                routePath: '/rights/logmanage',
                children: [
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t32'),
                        routeName: 'loglist',
    ...
    },
    {
        ...
        title: vueI18n.t('configMenu.t33'),
        routeName: 'pim',
        routePath: '/pim',
        children: [
            {
            ...
            },
            {
                ...
                title: vueI18n.t('configMenu.t41'),
                routeName: 'brandmanage',
                routePath: '/pim/brandmanage',
                children: [
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t42'),
                        routeName: 'brandlist',
            ...
            },
            {
                ...
                title: vueI18n.t('configMenu.t46'),
                routeName: 'labelmanage',
                routePath: '/pim/labelmanage',
                children: [
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t47'),
                        routeName: 'labellist',
                        routePath: '/pim/labelmanage/labellist'
                    },
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t48'),
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                title: vueI18n.t('configMenu.t52'),
                routeName: 'archivesmanage',
                routePath: '/orderhub/archivesmanage',
                children: [
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t53'),
    ...
    },
    {
        ...
        title: vueI18n.t('configMenu.t69'),
        routeName: 'inventory',
        routePath: '/inventory',
        children: [
            {
            ...
            },
            {
                ...
                title: vueI18n.t('configMenu.t78'),
                routeName: 'stock',
                routePath: '/inventory/stock',
                children: [
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t79'),
                        routeName: 'adjustmentlist',
                        routePath: '/inventory/stock/adjustmentlist'
                    },
                    {
                        tab: true,
                        title: vueI18n.t('configMenu.t80'),
    ...
    },
    {
        ...
        title: vueI18n.t('configMenu.t86'),
        routeName: 'crm',
        routePath: '/crm',
        children: [
            {
                ...
                title: vueI18n.t('configMenu.t87'),
                ...
                children: [
                    {
                        ...
                        children: [
                            ...
                            {
                                tab: true,
                                title: vueI18n.t('configMenu.t91'),
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            {
                                tab: true,
                                title: vueI18n.t('configMenu.t94'),
                            ...
                            {
                                tab: true,
                                title: vueI18n.t('configMenu.t95'),
            ...
            },
            {
                ...
                title: vueI18n.t('configMenu.t96'),
                routeName: 'more',
                routePath: '/crm/more',
                children: [
                    {
                        title: vueI18n.t('configMenu.t97'),
                        routeName: 'datamanage',
                        routePath: '/crm/more/datamanage',
                        children: [
                            {
                                tab: true,
                                title: vueI18n.t('configMenu.t98'),
                                routeName: 'metadata',
                            ...
                            {
                                tab: true,
                                title: vueI18n.t('configMenu.t99'),
